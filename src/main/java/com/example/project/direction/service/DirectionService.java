...
import com.example.project.direction.repository.DirectionRespository;
...
public class DirectionService {
    ...
    private final DirectionRespository directionRespository;
    ...
    public List<Direction> saveAll(List<Direction> directionList) {
        ...
        return directionRespository.saveAll(directionList);
    }

    public String findDirectionUrlById(String encodedId) {
        Long decodedId = base62Service.decodeDirectionId(encodedId);
        Direction direction = directionRespository.findById(decodedId).orElse(null);
